...
public class HerokuSeleniumTest  {
  ...
  public static void main(String[] args) throws Exception {
    ...
    while( iterations < 100 ) {
      try {
        ...
        driver.get("https://tapostagingweb.herokuapp.com");
        ...
        driver.get("https://tapostagingweb.herokuapp.com/schools/");
        Thread.sleep(4000);
        ...
        driver.get("https://tapostagingweb.herokuapp.com/teachers/");
        Thread.sleep(4000);
