...
class Test(unittest.TestCase):
	...
	def test_config(t):
		...
		config = [
			...
			call('graph_printf %3.0lf'),
			call('graph_scale yes'),
			call('f0_total.label total', '(pods: 2)'),
			...
			call('graph_printf %3.0lf'),
			call('graph_scale yes'),
			call('f0_total.label total', '(pods: 1)'),
			call('f0_total.colour COLOUR0'),
			call('f0_total.draw AREASTACK'),
			call('f0_total.min 0'),
			call('f1_avg.label average'),
			...
			call('graph_printf %3.0lf'),
			call('graph_scale yes'),
			call('f0_total.label total', '(pods: 5)'),
			call('f0_total.colour COLOUR0'),
			call('f0_total.draw AREASTACK'),
			call('f0_total.min 0'),
			call('f1_avg.label average'),
			...
			call('graph_printf %3.0lf'),
			call('graph_scale yes'),
			call('f0_total.label total', '(pods: 3)'),
			call('f0_total.colour COLOUR0'),
			call('f0_total.draw AREASTACK'),
			call('f0_total.min 0'),
			call('f1_avg.label average'),
