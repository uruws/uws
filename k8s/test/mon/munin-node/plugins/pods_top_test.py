...
class Test(unittest.TestCase):
	...
	def test_config(t):
		...
		config = [
			...
			call('ztotal.min 0'),
			# namespace cpu
			call('multigraph pod_top_cpu.cert_manager'),
			...
			call('f3_max.min 0'),
			call('multigraph pod_top_cpu.ingress_nginx'),
			...
			call('f3_max.draw LINE1'),
			call('f3_max.min 0'),
			call('multigraph pod_top_cpu.kube_system'),
			...
			call('f3_max.draw LINE1'),
			call('f3_max.min 0'),
			call('multigraph pod_top_cpu.mon'),
			...
			call('ztotal.min 0'),
			# namespace mem
			call('multigraph pod_top_mem.cert_manager'),
			...
			call('f3_max.draw LINE1'),
			call('f3_max.min 0'),
			call('multigraph pod_top_mem.ingress_nginx'),
			...
			call('f3_max.draw LINE1'),
			call('f3_max.min 0'),
			call('multigraph pod_top_mem.kube_system'),
			...
			call('f3_max.draw LINE1'),
			call('f3_max.min 0'),
			call('multigraph pod_top_mem.mon'),
	...
	def test_report(t):
		...
		report = [
			...
			call('f2_min.value', 1),
			call('f3_max.value', 4),
			call('multigraph pod_top_cpu.test'),
			...
			call('multigraph pod_top_mem.test'),
			call('f0_total.value', 'U'),
			call('f1_avg.value', 'U'),
			call('f2_min.value', 'U'),
			call('f3_max.value', 'U'),
